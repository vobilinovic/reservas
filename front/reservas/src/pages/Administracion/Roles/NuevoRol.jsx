    ...
    return (
        <div className="p-8">
            ...
            <div className="flex items-start justify-between mb-6">
                <div>
                    <h2 className="text-2xl font-bold text-blue-900 flex gap-2"><UserPlus/> Ingresar Rol</h2>
                    <p className="text-gray-400 text-sm mt-1">Completa los datos del nuevo rol.</p>
                </div>
                <button
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="flex gap-3 mt-5">
                    <BotonPrimario
                        tipo="submit"
                        texto={loading ? 'Ingresando...' : 'Ingresar Rol'}
                        disabled={loading}
                    />
                    <BotonSecundario
                        type="button"
