...
import { limpiarRut, mayusculas } from '../../../utils/helpers'
        ...
        async function datosUsuario() {
            try {
                ...
                setForm({
                    ...
                    password: '',
                    password_confirmation: '',
                    requiere_preferencia: !!usuario.requiere_preferencia,
    ...
    return (
        <div className="p-8">
            ...
            <div className="flex items-start justify-between mb-6">
                <div>
                    <h2 className="text-2xl font-bold text-blue-900 flex gap-2"><UserPen/> Editar Usuario</h2>
                    <p className="text-gray-400 text-sm mt-1">Modifica los datos del usuario.</p>
                </div>
                <button
            ...
            <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex-1 bg-white rounded-lg shadow-sm p-6">
                        ...
                        <div className="grid grid-cols-8 gap-4 mb-6">
                            ...
                            <div className="col-span-1">
                                ...
                                <input id="nombre" type="text" placeholder="Ej: Juan Perez"
                                    value={form.nombre}
                        ...
                        <div className="grid grid-cols-8 gap-4 mb-6">
                            <div className="col-span-2">
                                <label className={labelClass} htmlFor="empresa">Nueva Contraseña</label>
                            ...
                            <div className="col-span-2">
                                <label className={labelClass} htmlFor="empresa">Confirmar Contraseña</label>
                ...
                <div className="flex gap-3 mt-5">
                    <BotonPrimario
                        tipo="submit"
                        texto={loading ? 'Guardando…' : 'Guardar Usuario'}
                        disabled={loading}
                    />
                    <BotonSecundario
                        type="button"
